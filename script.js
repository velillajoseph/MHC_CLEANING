const translations = {
  es: {
    ...
    contactHelper: "Para respuesta más rápida, contáctanos por WhatsApp.",
    contactPanelTitle: "Métodos de contacto",
    contactCardWhatsappTitle: "WhatsApp",
    contactCardWhatsappHelper: "Mensaje directo para cotizaciones rápidas.",
    contactCardCallTitle: "Llamar",
    contactCardCallHelper: "+1 (939) 257-3875 · Disponible 8:00 AM – 6:00 PM",
    contactCardEmailTitle: "Correo",
    contactCardEmailHelper: "cleaningmhc@gmail.com · Escríbenos en español o inglés.",
    contactCardHoursTitle: "Horario",
    contactCardHoursHelper: "Domingo a Sábado – 8:00 AM a 6:00 PM",
    contactWhatsappLabel: "WhatsApp",
    contactWhatsappCopy: "Solicitar cotización por WhatsApp",
    contactPhoneLabel: "Llamar",
    contactPhoneValue: "+1 (939) 257-3875",
    contactEmailLabel: "Correo",
    contactEmailValue: "cleaningmhc@gmail.com",
    contactHoursLabel: "Horario",
    contactHoursValue: "Domingo a Sábado – 8:00 AM a 6:00 PM",
    contactWhatsappCta: "Abrir WhatsApp",
  ...
  en: {
    ...
    contactHelper: "For the fastest response, contact us on WhatsApp.",
    contactPanelTitle: "Contact Methods",
    contactCardWhatsappTitle: "WhatsApp",
    contactCardWhatsappHelper: "Direct message for quick quotes.",
    contactCardCallTitle: "Call",
    contactCardCallHelper: "+1 (939) 257-3875 · Available 8:00 AM – 6:00 PM",
    contactCardEmailTitle: "Email",
    contactCardEmailHelper: "cleaningmhc@gmail.com · Write to us in Spanish or English.",
    contactCardHoursTitle: "Hours",
    contactCardHoursHelper: "Sunday to Saturday – 8:00 AM to 6:00 PM",
    contactWhatsappLabel: "WhatsApp",
    contactWhatsappCopy: "Request a WhatsApp quote",
    contactPhoneLabel: "Call",
    contactPhoneValue: "+1 (939) 257-3875",
    contactEmailLabel: "Email",
    contactEmailValue: "cleaningmhc@gmail.com",
    contactHoursLabel: "Hours",
    contactHoursValue: "Sunday to Saturday – 8:00 AM to 6:00 PM",
